...
const Index = () => {
  return (
      ...
      <div className="areaone">
        ...
        <img src="/src/assets/iv7profile_final.webp" alt="Perfil de Ivan Garay" className="img__photo" />
        </div>
        ...
        <div className="inicio__container">
          ...
          <p className="text__inicio">
            ...
            deseas contactarme, puedes hacerlo a través de los enlaces de mis
            ...
            <div className="footer-section">
              <ul className="icon__list">
                <li className="icon__icons">
                  <a
                    href="https://www.facebook.com/search/top?q=aixa%20energia&locale=es_LA"
